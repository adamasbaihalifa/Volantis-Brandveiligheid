            ...
            if not start_rij.empty:
                ...
                with kol2:
                    ...
                    if not gegroepeerde_risicos.empty:
                        ...
                        plt.tight_layout()
                        st.pyplot(fig2)
                        st.write("data", gegroepeerde_risicos)
...
okey I want to add this feature. in the column kenmwerken I have some cells that are empty. so it is like this.
cell 1: Gebouwkenmerken - Algemeen
cell 2: None
cell 3: None
cell 4 Gebouwkenmerken - Aanvullend: Industriefunctie
cell 5: None
cell 6: None
cell 7: Gebouwkenmerken - Aanvullend: Woonfunctie (voor zorg)
etc.

for all the cells that are empty I want to fill the data that is above unless there is another one. so for cell 2 and 3 I want to Gebouwkenmerken - Algemeen. but cell 5 and 6 should be Gebouwkenmerken - Aanvullend: Industriefunctie because the one above is different. 